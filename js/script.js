...
window.addEventListener('DOMContentLoaded', function() {
		...
		counterBlock.addEventListener('keypress', () => {
				counterHours.value = '';
				counterRate.value = '';
		});
		...
		counterPages.addEventListener('keypress', () => {
				counterHours.value = '';
				counterRate.value = '';
			});		
		...
		counterHours.addEventListener('keypress', () => {
				counterBlock.value = '';
				counterPages.value = '';
			});
		...
		counterRate.addEventListener('keypress', () => {
				counterBlock.value = '';
				counterPages.value = '';
			});
